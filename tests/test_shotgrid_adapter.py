            ...
            self.mock_cut_items.append(
                {
                    ...
                    # TODO: check values generated by the writer, it seems strange
                    # to have a mismatch for timecode_edit_in_text but a match
                    # for timecode_edit_out_text?
                    "timecode_edit_in_text": "00:00:00:01",
                    "timecode_edit_out_text": "00:00:01:00",
                    "shot": shot,
